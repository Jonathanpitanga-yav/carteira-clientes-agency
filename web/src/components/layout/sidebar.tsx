...
function SidebarContent({ role, signOut }: { role: Role | null; signOut: () => void }) {
    ...
    <>
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent side="left" className="w-60 p-0">
          <SidebarContent role={role} signOut={() => { setOpen(false); signOut() }} />
        </SheetContent>
      </Sheet>
    </>
  )
