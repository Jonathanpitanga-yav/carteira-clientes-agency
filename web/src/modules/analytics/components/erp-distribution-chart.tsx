...
const ERP_COLORS = [
  "#6366f1", "#f59e0b", "#06b6d4", "#10b981", "#ef4444",
    ...
    <Card>
      <CardHeader className="pb-2">
        ...
        <p className="text-xs text-muted-foreground">
          {data.length} provedor(es) de ERP ativos
        </p>
      </CardHeader>
      <CardContent>
        <div className="h-[280px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <PieChart>
              ...
              <Tooltip
                formatter={(value) => typeof value === "number" ? formatCompactCurrency(value) : value}
              />
              <Legend
              ...
              >
                <div className="flex items-center gap-2">
                  <span
                    ...
                    style={{ backgroundColor: ERP_COLORS[index % ERP_COLORS.length] }}
                  />
                  <span className="font-medium">
                    {row.erp_provider === "unknown" ? "Outros" : row.erp_provider}
                  </span>
                  <span className="text-xs text-muted-foreground tabular-nums">
                    ({row.client_count} {row.client_count === 1 ? "cliente" : "clientes"})
                  </span>
                </div>
                <div className="flex items-center gap-3 tabular-nums">
                  ...
                  <span className={cn("font-semibold w-24 text-right")}>
