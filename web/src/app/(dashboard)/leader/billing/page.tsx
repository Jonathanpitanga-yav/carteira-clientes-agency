...
import { useMonthlyBilling, useDailyBilling } from "@/hooks/use-billing"
...
export default function LeaderBillingPage() {
  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        description="Visão geral de faturamento da agência"
      />
            ...
            {isLoading
              ...
              : monthly?.map((row, i) => (
                  <TableRow key={i}>
                    ...
                    <TableCell>
                      {formatCurrency(row.total_approved ?? 0)}
                    </TableCell>
